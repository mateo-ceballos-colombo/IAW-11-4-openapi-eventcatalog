...
name: OrderCreated
version: v1
summary: Representa la creación exitosa de una orden. Producido por el servicio Order Service al procesar POST /orders.
producers:
  - order-service
---
...
- **Ver también**: [OrderCancelled](http://localhost:3000/docs/events/OrderCancelled/v1) - Evento de cancelación de orden (puede seguir a OrderCreated).
